...
public:
   ...
   * @param c Translation from Vector default (0,0,0)*/
	explicit inline Transform(const Matrix3x3& b, 
		const Vector3& c = Vector3(tf2Scalar(0), tf2Scalar(0), tf2Scalar(0)))
		: m_basis(b),
		m_origin(c)
	{}
...
/**@brief Return the transform of the vector */
  ...
  /**@brief Return the basis matrix for the rotation */
	inline Matrix3x3&       getBasis()          { return m_basis; }
  /**@brief Return the basis matrix for the rotation */
	inline const Matrix3x3& getBasis()    const { return m_basis; }
   ...
   * @param origin The vector to set the translation to */
	...
	inline Vector3 invXform(const Vector3& inVec) const;
